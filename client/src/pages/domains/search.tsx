      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-3">
          {[
            ...
            { tld: '.net', price: '$13.99/yr' },
            { tld: '.org', price: '$12.99/yr' },
            { tld: '.io', price: '$39.99/yr' },
            { tld: '.co', price: '$29.99/yr' },
            { tld: '.dev', price: '$16.99/yr' },
            { tld: '.app', price: '$17.99/yr' },
            { tld: '.ai', price: '$49.99/yr' },
            { tld: '.tech', price: '$12.99/yr' },
            { tld: '.cloud', price: '$21.99/yr' },
            { tld: '.shop', price: '$14.99/yr' },
            { tld: '.store', price: '$16.99/yr' },
            { tld: '.online', price: '$15.99/yr' },
            { tld: '.site', price: '$12.99/yr' },
            { tld: '.xyz', price: '$12.99/yr' },
            { tld: '.me', price: '$11.99/yr' },
            { tld: '.design', price: '$34.99/yr' },
            { tld: '.agency', price: '$24.99/yr' },
            { tld: '.studio', price: '$27.99/yr' },
            { tld: '.pro', price: '$12.99/yr' },
          ].map((item) => (
            <div
              key={item.tld}
